...
Measuring populatio growth rate has many uses in traditional human demography, such as:

**Assessing and mitigating the risk of Malthusian traps in resource allocation due to diminish marginal returns**
...
**Assessing and mitigating the risks that slow population growth leads to population aging**
...
:::{.rmdtip}
**DEMOGRAPHY & DATASCIENCE**

#### Customer demand vs. workforce supply: Challenges to company scale {.unnumbered}

If employee headcount grows too slowly or shrinks due to attrition: 
...
If customer headcount grows too quickly or shrinks, again you can't meet demand
:::

### Crude growth rate

The crude growth rate combines the [Principal period rates in demography] into an expression of how a population grows between to time points (e.g., $0$ and $T$)
...
CBR measures growth between two time points $0$ and $T$, but what about the pace of population growth at a specific point in time $0 < t < T$?

...
### Converting ${}_{n}q_x^i$ to ${}_{n}q_x^i$: Easier than it sounds! {.unnumbered}
...
\frac{{}_{n}q_x^i}{{}_{n}q_x}
 = \frac{{}_{n}d_x^i / \bcancel{l_x}}{{}_{n}d_x^i / \bcancel{l_x}}
 = \frac{{}_{n}d_x^i}{{}_{n}d_x^i}
 = \frac{{}_{n}d_x^i / \bcancel{{}_{n}L_x}}{{}_{n}d_x^i / \bcancel{{}_{n}L_x}}
...
{}_{n}^*m_x^i|_{\mu^i(x) = \color{purple}{\gamma}}
  ...
  &= \frac{
    ...
    \int_x^{x+n} e^{-\int_x^a \color{purple}{\gamma}dy}
  } \\
  &= \frac{
    \int_x^{x+n}
      e^{-\int_x^a \color{olive}{\mu(y)}dy}
...
**DISCUSSION:** What are some cases when you wouldn't expect proportional hazards? **Hint:** Think of decrement causes that differ in their age-specific rate schedules.
<br><br>
